    ...
    <div class="row mb-4">
        <div class="col-md-12 mb-4">
            <div class="card text-right" style="align-items: end;box-shadow: none !important;">
                <a href="{{ route('agerence.jobs.create') }}" class="col-md-2 btn btn-primary">+ Nuevo trabajo</a>
            </div>
                        ...
                        <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach($jobs as $job)
                                    <tr>
                                        <td>
                                            <a href="{{ route('agerence.jobs.show', $job->id) }}">
                                                {{ $job->id }}
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary" href="{{ route('agerence.jobs.show', $job->id) }}">
