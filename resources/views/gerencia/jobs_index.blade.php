                        ...
                        <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                @foreach($jobs as $job)
                                    <tr>
                                        <td>
                                            <a href="{{ route('gerencejobs.show', $job->id) }}">
                                                {{ $job->id }}
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary" href="{{ route('gerencejobs.show', $job->id) }}">
    ...
    <script>
        $(document).ready(function(){
            $('#zero_configuration_table').DataTable({
				...
				infoEmpty:      "No tiene trabajos asignados aún",
				infoFiltered:   "Información refinada",
				infoPostFix:    "",
				loadingRecords: "Procesando...",
				zeroRecords:    "No tiene trabajos asignados aún",
				emptyTable:     "No tiene trabajos asignados aún",
				paginate: {
					first:      "Primero",
					previous:   "<",
					next:       ">",
